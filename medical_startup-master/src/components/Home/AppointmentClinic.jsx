  ...
  const clinics = [
    {
      id: 1,
      name: "Main Branch",
      location: "location:kankarbagh, Patna",
      image: img1,
      ...
      doctors: [
        {
          ...
          image: doctorImg1,
          clinicLocation: "Clinic location:123 Main St, New York, NY",
        ...
        },
        {
          ...
          specialty: "speciality:Pediatrician",
          image: doctorImg2,
      ...
      <div className="buttom-section">
        ...
        <div className="doctor-list">
          <div className="doctor-card">
            <div className='doctor-c'>
              ...
              <div className="doctor-details-appoint">
                <h3>Name: Dr Soumpdeep Pal</h3>
                <p className='speciality'><span>Specialty:</span>Cardiologist</p>
                <p className='location'><span>Location:</span>123 Main St, Bankura</p>
                <p className='slots'><span>Available Slots:</span>["9:00 AM-11:00 AM", "10:00 AM-12:30 PM", "7:00 PM-9:00 PM"]</p>
                <p className='fees'><span>ConsultantFees:</span>600</p>
          ...
          <div className="doctor-card">
            <div className='doctor-c'>
              <div className="doctor-image">
                <img src={doctorImg2} alt="bhbhb" />
              </div>
              <div className="doctor-details-appoint">
                <h3>Name:Dr. Soumyadeep Sardar</h3>
                <p className='speciality'><span>Specialty:</span>Pediatric Surgeon MS</p>
                <p className='location'><span>Location:</span>456 Elm St, Kolata</p>
          ...
          <div className="doctor-card">
            <div className='doctor-c'>
              ...
              <div className="doctor-details-appoint">
                ...
                <p className='fees'><span>ConsultantFees:</span>5000</p>
                <Link to="/appointment" className="book-appointment-link">
                  <button id="button">Book Appointment</button>
                </Link>
              </div>
